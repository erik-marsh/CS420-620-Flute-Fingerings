    ...
    public void MidiReadEvents(List<MPTKEvent> midiEvents)
    {
        ...
        if (midiFilePlayer.MPTK_TickCurrent >= ConvertBarToTick(LoopBar) - 1)
        {
         ...
         //   midiFilePlayer.MPTK_StopSynth();
            ...
            //// Comment if you have the Pro version and uncomment further up for a delayed start 
            //// Delayed start for 2 seconds with a volume rampup of 0.1 second. (PRO only)
