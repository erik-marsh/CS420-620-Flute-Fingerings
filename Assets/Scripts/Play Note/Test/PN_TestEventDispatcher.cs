...
namespace NotePlayer
{
    ...
    public class PN_TestEventDispatcher : MonoBehaviour
    {
        ...
        public enum TestChoice { test1, test2, test3 }
        ...
        private void Start()
        {
            switch(TestToRun)
            {
                ...
                case TestChoice.test3: StartCoroutine(I_Test3(5f)); break;
        ...
        /// <summary>
        /// Periodically sends a note event with a set duration, then induce playback, then kill the playback early
        /// </summary>
        protected IEnumerator I_Test3(float duration)
        {
            //__recording start___
            Options.Test2_EventHandler.StartRecording();
            ...
            //this will cancel halfway through playback
